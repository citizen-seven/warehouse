...
void tree_put_data_left(p_tree TREE, double data) //This function put value into field "data" of the left child of tree
{
    p_tree tmp = tree_ctor();
    TREE -> left_next = tmp;
    tmp -> prev = TREE;
...
void tree_put_data_right(p_tree TREE, double data) //This function put value into field "data" of the right child of tree
{
    p_tree tmp = tree_ctor();
    TREE -> right_next = tmp;
    tmp -> prev = TREE;
